...
[Migration("20260523120000_AddEvidenceArchivedAt")]
public partial class AddEvidenceArchivedAt : Migration
{
    /// <inheritdoc />
...
""");
    ...
    {
        migrationBuilder.Sql("""
ALTER TABLE evidence DROP COLUMN IF EXISTS "ArchivedAt";
""");
    }
}
