...
export const APP_ROUTES: Routes = [
...

  {
    ...
    children: [
      ...
      { path: 'blocks',
        loadComponent: () => import('./features/block-builder/block-builder.component').then(m => m.BlockBuilderComponent),
      },
      { path: 'topics',
        loadComponent: () => import('./features/topic-builder/topic-builder.component').then(m => m.TopicBuilderComponent),
      },
      { path: 'modules',
        loadComponent: () => import('./features/module-builder/module-builder.component').then(m => m.ModuleBuilderComponent),
      },
      { path: 'curricula',
        loadComponent: () => import('./features/curriculum-builder/curriculum-builder.component').then(m => m.CurriculumBuilderComponent),
      },
      { path: 'hierarchy',
        loadComponent: () => import('./features/hierarchy-explorer/hierarchy-explorer.component').then(m => m.HierarchyExplorerComponent),
      },
      { path: 'templates',
