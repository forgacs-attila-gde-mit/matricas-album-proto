...
## Step 2 — Find Where to Save the Plan
...
## Tests
[Complete list of ALL test cases across the entire plan:]
- **[test name]** (unit | integration | e2e | live e2e): one-line description

---

## Documentation update
- [ ] [Doc name], section: [section], path: `path/to/doc.md`
...
**Tests**: Every task needs at minimum unit tests. Add integration, e2e, and live e2e wherever the task crosses component or system boundaries.
...
5. Update the Tests and Documentation sections to reflect additions
